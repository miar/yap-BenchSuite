...
show_facts :- ground__1(_63),
              numbervars([_63]),
              query_output([ground(_63), '\n']),
              fail.
show_facts :- quantity__1(_63),
              numbervars([_63]),
              query_output([quantity(_63), '\n']),
              fail.
show_facts :- empty__1(_63),
              numbervars([_63]),
              query_output([empty(_63), '\n']),
              fail.
show_facts :- cuth__1(_63),
              numbervars([_63]),
              query_output([cuth(_63), '\n']),
              fail.
show_facts :- cutv__1(_63),
              numbervars([_63]),
              query_output([cutv(_63), '\n']),
              fail.
show_facts :- wasteh__1(_63),
              numbervars([_63]),
              query_output([wasteh(_63), '\n']),
              fail.
show_facts :- wastev__1(_63),
              numbervars([_63]),
              query_output([wastev(_63), '\n']),
              fail.
show_facts :- vertical__1(_63),
              numbervars([_63]),
              query_output([vertical(_63), '\n']),
              fail.
show_facts :- ground_list__1(_63),
              numbervars([_63]),
              query_output([ground_list(_63), '\n']),
              fail.
show_facts :- horizontal__1(_63),
              numbervars([_63]),
              query_output([horizontal(_63), '\n']),
              fail.
