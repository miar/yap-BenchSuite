%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%% File:     test_magic_cube_6.pl
%% Added by: Ricardo Rocha
%% Program:  3x3x3 magic cube problem, writen by Ricardo Rocha 1996
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

time_query:- parallel(magic(X)),
             fail.

debug_query:- parallel_findall(X,magic(X),L),
...
magic(S):- magic_go(6,S).

magic_go(N,S):- magic_problem(N,Y), magic_solve(N,Y,S).
